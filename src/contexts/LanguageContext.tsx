...
const translations: Record<Language, Record<string, string>> = {
  ...
  ar: {
    ...
    'about.description': 'منذ عام ١٩٨٤، حوّل الأخوان هادي وسعيد القحطاني شركة هافكو من عملية تعتمد شاحنةً واحدةً إلى واحدة من أكثر شركات النقل الثقيل موثوقية في المنطقة الشرقية. ومقرنا الدمام، ونحمل ترخيصاً كاملاً تحت السجل التجاري ٢٠٥٠٠٤٢٨٤٦، ننقل المعدات الضeditoبرة وأنابيب البترول والمكونات الصناعية التي تُشغّل قطاعات الطاقة والبنية التحتية في المملكة. أربعة عقود من الخدمة المتواصلة لكبرى الشركات — من أرامكو إلى شركاء اللوجستيات الدوليين — علّمتنا أن الموثوقية ليست شعاراً؛ إنها عادةٌ تُصاغ عبر آلاف عمليات التسليم الآمنة والموثوقة.',
    ...
    'about.vision': 'رؤيتنا',
    'about.visionText': true': 'أن نبقى الخيار الأول في المنطقة الشرقية للنقل الثقيل والخدمات اللوجستية للمشاريع — مُطوّرين قدراتنا دون أن نفرّط بالموثوقية والمسؤولية الشخصية التي بنت اسم هافكو منذ عام ١٩٨٤.',
