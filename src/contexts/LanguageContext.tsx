...
const translations: Record<Language, Record<string, string>> = {
  ...
  ar: {
    ...
    'about.missionText': 'أن نقدّم حلولاً للنقل العام والثقيل آمنةً وموثوقةً ومتقنة، تتجاوز توقّعات عملائنا وتُحافظ على أرفع معايير الاحترافية.',
    'about.vision': 'رؤيتنا',
    'about.visionText': 'أن نبقى الاسم الأول في النقل الثقيل بالشرق الأوسط، عنواناً للموثوقية والإتقان ورضا العملاء.',
