          ...
          <div className="container mx-auto px-4">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {licenses.map((license, i) => (
                  <ScrollReveal key={i} variant="fadeUp" delay={i * 0.08}>
                    <div className="bg-card p-6 rounded-xl border border-border hover-lift h-full">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8 max-w-2xl mx-auto">
                {owners.map((owner, i) => (
                  <ScrollReveal key={i} variant="scaleIn" delay={i * 0.1}>
                    <div className="bg-card p-6 rounded-xl border-2 border-gold text-center hover-lift">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {reasons.map((reason, i) => (
                <ScrollReveal key={i} variant="fadeUp" delay={i * 0.1}>
                  <div className="bg-card p-6 rounded-xl border border-border text-center hover-lift h-full">
