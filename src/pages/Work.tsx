...
const Work = () => {
  ...
  const projects = [
    ...
    { titleEn: 'Desalination Pumps - Jubail', titleAr: 'مضخات تحلية - الجبيل', descEn: 'Large-scale water pumping units delivered to Jubail desalination plant.', descAr: 'توصيل وحدات ضخ مياه كبيرة إلى محطة تحلية الجبيل.', image: workImg8 },
    ...
    <PageTransition>
      <div>
        ...
        <section className="relative h-[70vh] min-h-[500px] flex items-end overflow-hidden -mt-20">
          <img src={workImg1} alt="Our Work" className="absolute inset-0 w-full h-full object-cover" />
